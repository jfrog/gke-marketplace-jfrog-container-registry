...
```shell
docker pull gcr.io/jfrog-gc-mp/jfrog-jcr/deployer:7.5
```
...
```shell
./scripts/mpdev scripts/install  --deployer=gcr.io/jfrog-gc-mp/jfrog-jcr/deployer:7.5   --parameters='{"name": "'$NAME'", "namespace": "'$NAMESPACE'"}'
