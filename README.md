...
```shell
docker pull gcr.io/jfrog-gc-mp/jfrog-jcr/deployer:$DEPLOYER_TAG
```
...
```shell
./scripts/mpdev scripts/install  --deployer=gcr.io/jfrog-gc-mp/jfrog-jcr/deployer:$DEPLOYER_TAG   --parameters='{"name": "'$NAME'", "namespace": "'$NAMESPACE'"}'
